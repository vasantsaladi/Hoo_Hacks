      ...
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-12">
          ...
          <p className="mt-2 text-lg text-gray-600">
            Guiding you to a future with less waste
          </p>
        </header>
        ...
        <div className="bg-gray-50 p-8 rounded-lg shadow-md mb-8 border border-gray-200">
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">
            Restaurant Food Waste Prediction Model
          </h2>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  ...
                  <span>
                    Advanced machine learning model with{" "}
                    <strong>78% accuracy</strong>
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 text-xl">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 text-xl">•</span>
                  <span>
                    Interactive visualizations of waste metrics and targets
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 text-xl">•</span>
                  <span>
                    Environmental impact analysis with CO2 emissions tracking
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div className="bg-white p-4 rounded-lg border border-gray-200 hover:border-green-500 hover:shadow-md transition-all">
              ...
              <p className="text-gray-600">
                Food waste in landfills produces methane, a greenhouse gas 25
                times more potent than CO2. Reducing waste helps combat climate
                change.
              </p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200 hover:border-green-500 hover:shadow-md transition-all">
              ...
              <p className="text-gray-600">
                Restaurants can save up to 10% on food costs by implementing
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200 hover:border-green-500 hover:shadow-md transition-all">
              ...
              <p className="text-gray-600">
                With millions facing food insecurity, reducing waste and
                donating excess food can make a significant social impact.
              </p>
            </div>
          </div>
        </div>
